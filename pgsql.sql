...
--------------------------------------------------
select *
from public."PCRCallRecordSessions" sessions
where sessions."Modalities" like '%Audio%'
limit 10;
--------------------------------------------------
select *
...
limit 10;
-----------------------------------------
select caller."UPN" as CallerUPN,
   Callee."UPN" as CalleeUPN,
   *
from public."PCRCallRecordDetails" details
   left join public."PCRCallRecordSessions" sessions on sessions."CallId" = details."Id"
   left join public."PCRCallRecordSegments" segments on sessions."Id" = segments."SessionId"
   left join public."LicensedUsers" Caller on sessions."Caller" = caller."Id"
   left join public."LicensedUsers" Callee on sessions."Callee" = callee."Id"
where details."CallType" = 'PeerToPeer'
limit 10;
--------------------------------------------------
select *
from public."PCRCallRecordSegments"
limit 10;
--------------------------------------------------
select *
from public."LicensedUsers" users
limit 10;
---------------------------------------------------
select *
from "PCRCallRecordStreams"
limit 10;
select *
from "PCRCallRecordMedias"
where "CallType" = 'PeerToPeer'
LIMIT 10;
select *
from public."History_PCRCallRecordNetworks_2023-05"
LIMIT 10;